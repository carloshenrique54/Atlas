...
function Cadastro(){
    ...
    async function FazerCadastro(e){
        ...
        if (errorEmail)    { alert("Erro: " + errorEmail.message); return }
        ...
        if (errorFuncCpf)    { alert("Erro: " + errorFuncCpf.message); return }
        ...
        const { error: errorUsuario } = await supabase
            .from("usuarios")
            .insert([{ cpf: cpfLimpo, nome: nomeUsuario, email, senha, plano: "Starter", telefone: telLimpo }])
